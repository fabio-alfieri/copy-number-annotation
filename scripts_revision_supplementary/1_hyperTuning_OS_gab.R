...
print(setdiff(c("Density.Ohnologs", "Density.complex.proteins", "ESSscore_pancancer",
                ...
                "total_n_paralogs_trans", "total_n_partners.trans"), colnames(ml_table))) 
...
saveRDS(xgb_tune, file = paste0('/home/ieo7429/Scrivania/hyperparam_tuning/', 
                                classS, '_hyper_tuning_OS.rds')) # remember here it's related to last trained model. Improve

rm(ctrl, correlation_summary, param_grid, xgb_tune,
