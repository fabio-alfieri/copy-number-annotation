...
X_data <- ml_table[,colnames(ml_table) %in% c("Density.Ohnologs",               
                                              "Density.complex.proteins",       
                                              "ESSscore_pancancer",            
                                              "Ess.distance_pancancer",
                                              "HAPLOscore_pancancer",
                                              "all.int.trans",
                                              "dist.to.closest.OG",
                                              "dist.to.closest.TSG",
                                              "density.OG", 
...
print(setdiff(c("Density.Ohnologs", "Density.complex.proteins", "ESSscore_pancancer",
          "Ess.distance_pancancer", "HAPLOscore_pancancer", "all.int.trans",
          "dist.to.closest.OG", "dist.to.closest.TSG", "density.OG",
          "density.TSG", "genes.bin", "mutations_norm", "partners.trans",
          "total_n_PPIs.trans", "total_n_ohnologs.mmpaper_trans",
          "total_n_paralogs_trans", "total_n_partners.trans"), colnames(ml_table)))  # should be character(0) — shows any names that didn't match
