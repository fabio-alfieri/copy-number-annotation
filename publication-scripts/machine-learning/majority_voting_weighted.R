...
avg_performances <- read.table(file = "../Data/results_regressor/avg_performances_final.tsv", header = T, sep = "\t")
correlations <- read.table(file = "../Data/results_regressor/cor_final.tsv", header = T, sep = "\t")
...
pdf('../Data/plots/ampl_del_weigthed_corP_selectionFeatures.pdf', width = 12, height = 8)
corP_imp_features
dev.off()

pdf('../Data/plots/ampl_del_weigthed_corP_selectionFeatures.pdf', width = 12, height = 4)
corP_selection
dev.off()
pdf('../Data/plots/ampl_del_weigthed_corP_occurrenceFeatures.pdf', width = 12, height = 8)
corP_occurrence
dev.off()
pdf('../Data/plots/ampl_del_weigthed_corS_selectionFeatures.pdf', width = 12, height = 4)
corS_selection
dev.off()
...
write.table(x = final_verdict, file = "..Data/results_regressor/final_verdict.tsv", sep = "\t", 
