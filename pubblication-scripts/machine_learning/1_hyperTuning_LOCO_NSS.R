...
X_train <- X_data[chr_idxs, ]
X_test <- X_data[-chr_idxs, ]
y_train <- y_data[chr_idxs]
y_test <- y_data[-chr_idxs]
...
saveRDS(xgb_tune, file = paste0('/home/ieo7429/Scrivania/hyperparam_tuning/', 
                                classS, '_hyper_tuning_LOCO_NSS_', chromosome, '.rds')) # remember here it's related to last trained model. Improve
