...
load("/home/ieo7429/Scrivania/results_regressor_gab/SHAP/Avg_shap_values_InteractomeINSIDER.RData")

models.X_ampl <- rbind(models.X.train$`Mid-length::Amplification model`, models.X.test$`Mid-length::Amplification model`)
models.X_del <- rbind(models.X.train$`Mid-length::Deletion model`, models.X.test$`Mid-length::Deletion model`)
 
df <- list(models.X = list(`Mid-length::Amplification model` = models.X_ampl,
                           `Mid-length::Deletion model` = models.X_del),
...
write_rds(df, file = '/home/ieo7429/Scrivania/dev/Data/SHAP_and_FeatureMatrix_Mid-length_AmplDel.rds')
df <- readRDS(file = '/home/ieo7429/Scrivania/dev/Data/SHAP_and_FeatureMatrix_Mid-length_AmplDel.rds')

source('/home/ieo7429/Scrivania/residuals_plot_gab.R')
res.ampl <- plot_residuals(read_rds('/home/ieo7429/Scrivania/dev/Data/pred_ampl.rds'))
res.del <- plot_residuals(read_rds('/home/ieo7429/Scrivania/dev/Data/pred_del.rds'))
