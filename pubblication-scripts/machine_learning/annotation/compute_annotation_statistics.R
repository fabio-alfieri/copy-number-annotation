...
setwd("/home/ieo7429/Scrivania/dev/Data/new_stuff/")
annots <- list.files(".", pattern = "res_ratio_with")
...
write.table(x = summary_statistics, file = "summary_statistics.tsv", quote = F, col.names = T)
