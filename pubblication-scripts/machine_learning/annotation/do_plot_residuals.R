...
if (save) {
  ...
  ggsave(filename = paste0(i, "_pancancer_residuals.pdf"), plot = pancancer_residuals, width = 15, height = 14, dpi = 300)
  ggsave(filename = paste0(i, "_tumor_specific_residuals.pdf"), plot = tumor_specific_residuals , width = 15, height = 14, dpi = 300)
