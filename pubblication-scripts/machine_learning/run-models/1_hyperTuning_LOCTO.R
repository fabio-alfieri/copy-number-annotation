...
X_train <- X_data[ct_idxs, ]
X_test <- X_data[-ct_idxs, ]
y_train <- y_data[ct_idxs]
y_test <- y_data[-ct_idxs]
...
saveRDS(xgb_tune, file = paste0('/home/ieo7429/Scrivania/hyperparam_tuning/', 
                                classS, '_hyper_tuning_LOCTO_', ct, '.rds')) # remember here it's related to last trained model. Improve
