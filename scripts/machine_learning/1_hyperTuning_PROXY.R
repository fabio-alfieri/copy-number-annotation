...
ml_table[ml_table$Chromosome_Length == curr_length,"Chromosome_Length"] <- as.numeric(curr_proxy)
}
...
saveRDS(xgb_tune, file = paste0('/home/ieo7429/Scrivania/hyperparam_tuning/', 
                                classS, '_hyper_tuning_PROXY.rds')) # remember here it's related to last trained model. Improve
