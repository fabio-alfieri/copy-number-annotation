...
load("/mnt/ghost/fabiogokce/gokce/Data/All_levels_backbonetables.RData")
load("/mnt/ghost/fabiogokce/gokce/Data/Ensembl_CORUM_features_tissue_general.RData")

####################### 

setwd("dev/imgs/gene_specific_performances/")
...
p1_name <- paste0(model_class, "_", i, "_genes_free_scatterplot.pdf")
pdf(p1_name)
...
p2_name <- paste0(model_class, "_", i, "_genes_populated_scatterplot.pdf")
pdf(p2_name)
...
p3_name <- paste0(model_class, "_", i, "_all_regions_scatterplot.pdf")
pdf(p3_name)
plot(res$observed,
     res$prediction,
...
write.table(x = output, 
            file = "dev/Data/gene_specific_performance/segment_specific_performances.tsv", 
...
ggsave("dev/imgs/gene_specific_performances/CNA_performance_grouped_barplot.pdf", plot = p,
