gains <- read.table("../dev/Data/gain_table.tsv", header = T, sep = "\t")
...
ggsave("gains_ampl_sel.pdf", p1, width = 7, height = 5)
...
ggsave("gains_del_occ.pdf", p2, width = 7, height = 5)
...
ggsave("gains_del_sel.pdf", p3, width = 7, height = 5)
...
ggsave("gains_ampl_occ.pdf", p4, width = 7, height = 5)
